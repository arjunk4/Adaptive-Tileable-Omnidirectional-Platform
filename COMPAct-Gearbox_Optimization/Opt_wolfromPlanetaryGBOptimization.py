...
maxGearboxDiameter_Motor6375           = maxGBDia_multFactor * Motor6375.motorDiaMM     - 2*wpg_design_params["ringRadialWidthMMBig"]
#maxGearboxDiameter_U8           = maxGBDia_multFactor * MotorU8.motorDiaMM     - 2*wpg_design_params["ringRadialWidthMMBig"] 

Actuator_Motor6375     = wolfromPlanetaryActuator(design_parameters        = wpg_design_params,
                                           motor                    = Motor6375,
...
Optimizer_Motor6375     = optimizationWolfromPlanetaryActuator(design_parameters          = wpg_design_params         ,
                                                        gear_standard_parameters   = Gear_standard_parameters  ,
                                                        K_Mass                     = K_Mass                    ,
                                                        K_Eff                      = K_Eff                     ,
                                                        K_Width                    = K_Width                   ,
...
print("Optimization Completed : WPG  Motor6375 : Time Taken:", totalTime_Motor6375)
